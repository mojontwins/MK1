...
..\..\..\src\utils\rle53map_sp.exe in=..\map\mapa.map mk1h=assets\mapa.h out=mapa size=8,9 mk1locks fixmappy > nul
...
echo Importando GFX
..\..\..\src\utils\ts2bin.exe ..\gfx\font.png ..\gfx\work.png tileset.bin 5 >nul
