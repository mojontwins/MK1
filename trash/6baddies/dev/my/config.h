...
#define MIN_FAPS_PER_FRAME			4		// Limits the max # of fps to 50/N
...
//#define NO_MASKS					sp_XOR_SPRITE	// Sprites are rendered using OR/XOR instead of masks.
...
unsigned char behs [] = {
	0, 8, 8, 8, 4, 8, 0, 8, 0, 0, 0, 0, 0, 0, 8, 8,
