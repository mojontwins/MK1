...
..\utils\mapcnvbin.exe ..\map\mapa.map ..\bin\mapa.bin 5 7 15 10 15 packed fixmappy > nul

rem We need a compressed copy for this game
del ..\bin\mapa.c.bin > nul
..\utils\zx0.exe ..\bin\mapa.bin ..\bin\mapa.c.bin > nul
...
..\utils\zx0.exe ..\gfx\title.scr ..\bin\title.bin > nul

del ..\bin\marco.bin > nul
..\utils\zx0.exe ..\gfx\marco.scr ..\bin\marco.bin > nul

del ..\bin\ending.bin > nul
..\utils\zx0.exe ..\gfx\ending.scr ..\bin\ending.bin > nul
