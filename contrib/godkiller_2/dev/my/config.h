...
#define SCR_INICIO					34		// Initial screen
...
#define LINE_OF_TEXT_X				6		// X coordinate.
...
#define PLAYER_AX					128		// Acceleration
#define PLAYER_RX					128		// Friction
...
unsigned char behs [] = {
	0, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8,8, 10,
	0, 0, 0, 8, 0, 0, 0, 8, 8, 8, 8, 8, 8, 8, 8, 8,
	8, 8, 8, 0, 8, 8, 8, 8, 8, 0, 8, 8, 8, 8, 8, 8,
};
#endif
