...
//#define MAX_AMMO					20		// If defined, ammo is not infinite!
...
#define LIFE_X						0		//
#define LIFE_Y						12		// Life gauge counter character coordinates
#define OBJECTS_X					99		//
...
#define PLAYER_MAX_VY_CAYENDO		384 	// Max falling speed
#define PLAYER_G					24		// Gravity acceleration
...
#define PLAYER_AX					24		// Acceleration
...
unsigned char behs [] = {
	0, 8, 8, 8, 8, 8, 8, 8, 8, 4, 1, 2, 2, 2, 2, 2,
