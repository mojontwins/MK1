...
// Copyleft 2010-2014, 2020 by the Mojon Twins
	...
	#define SFX_START 				18
	#define SFX_BREAKABLE_HIT 		7
	#define SFX_BREAKABLE_BREAK 	7
	#define SFX_PUSH_BOX 			3
	#define SFX_OPEN_LOCK 			3
	#define SFX_SHOOT 				4
	#define SFX_OBJECT_GET 			8
	#define SFX_KILL_ENEMY_STEP 	6
	#define SFX_KILL_ENEMY_SHOOT	6
	#define SFX_HIT_ENEMY 			7
	#define SFX_ONE_OBJECT_GET		15
	#define SFX_ONE_OBJECT_WRONG 	15
	#define SFX_KEY_GET 			11
	#define SFX_REFILL_GET 			11
	#define SFX_JUMP 				1
	#define SFX_SPIKES 				17
	#define SFX_ENEMY_HIT 			17
