' rle62map_sp v0.1
' fbc rle62map_sp.bas cmdlineparser.bas mtparser.bas
...
Sub usage 
	Print "usage:"
	Print ""
	Print "rle62map_sp.exe in=map.map out=map.bin size=W,H [tlock=T] [mk1locks]"
...
Print "rle62map_sp v0.2.20200214 ~ ";
...
For nPant = 0 To maxPants - 1
	...
	For i = 1 To scrW*scrH-1
		...
		If BigMap (nPant, i) <> d Or n = 4 Then
			cMap (nPant, cMapI) = (d And 63) Or ((n - 1) Shl 6)
...
If sclpGetValue ("mk1h") <> "" Then
	...
	Print #fOut, "// Mapa.h "
	Print #fOut, "// Generated by rle62map_sp v0.2.20200214"
