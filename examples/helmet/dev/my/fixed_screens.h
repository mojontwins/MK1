...
void game_ending (void) {
	...
	// Custom for Helmet
	#ifdef LANG_ES
		_x = 10; _y = 16; _t = 70; _gp_gen = (unsigned char *) ("ENHORABUENA!"); print_str ();
		_x =  2; _y = 18; _t = 71; _gp_gen = (unsigned char *) ("CONSEGUISTE PONER LAS BOMBAS"); print_str ();
		_x =  4; _y = 20;          _gp_gen = (unsigned char *) ("Y DESTRUIR EL ORDENADOR!"); print_str ();
		_x =  8; _y = 22;          _gp_gen = (unsigned char *) ("MISION CUMPLIDA!!"); print_str ();
	#else
		_x =  8; _y = 16; _t = 70; _gp_gen = (unsigned char *) ("CONGRATULATIONS!"); print_str ();
		_x =  2; _y = 18; _t = 71; _gp_gen = (unsigned char *) ("YOU MANAGED TO SET THE BOMBS"); print_str ();
		_x =  4; _y = 20;          _gp_gen = (unsigned char *) ("AND DESTROY THE COMPUTER"); print_str ();
		_x =  5; _y = 22;          _gp_gen = (unsigned char *) ("MISSION ACCOMPLISHED!!"); print_str ();
	#endif
	sp_UpdateNowEx (0);
