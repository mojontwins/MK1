...
if clausulasUsed (&H20) Then
	...
	print #f, "                    x = read_vbyte ();"
	print #f, "                    y = read_vbyte ();"	
	print #f, "                    terminado = (!((px >> 6) >= (x << 4) - 15 && (px >> 6) <= (x << 4) + 15 && (py >> 6) >= (y << 4) - 15 && (py >> 6) <= (y << 4) + 15));"
	print #f, "                    break;"
end if
...
if clausulasUsed (&H21) Then
	...
	print #f, "                    x = read_byte ();"
	print #f, "                    y = read_byte ();"	
	print #f, "                    terminado = (!((px >> 6) >= x && (px >> 6) <= y));"
	print #f, "                    break;"
end if
...
if clausulasUsed (&H22) Then
	...
	print #f, "                    x = read_byte ();"
	print #f, "                    y = read_byte ();"	
	print #f, "                    terminado = (!((py >> 6) >= x && (py >> 6) <= y));"
	print #f, "                    break;"
end if
...
if clausulasUsed (&H30) Then
	...
	print #f, "                    // Opcode: 30"
	print #f, "                    terminado = (pkilled != BADDIES_COUNT);"
	print #f, "                    break;"
end if
