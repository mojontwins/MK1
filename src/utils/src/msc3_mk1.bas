...
if command (1) = "" or  maxidx = 0 then
	...
	Print
	print "usage: msc3 input n_rooms [rampage]"
	print ""
...
Print #f3, "}"
Print #f3, ""
Print #f3, "#if !(defined (PHANTOMAS_ENGINE) || defined (HANNA_ENGINE))"
...
print #f3, "#if defined (PHANTOMAS_ENGINE) || defined (HANNA_ENGINE)"
Print #f3, "    p_x = read_vbyte () << 4;"
Print #f3, "    p_y = read_vbyte () << 4;"
print #f3, "#else"
...
if clausulasUsed (&H20) Then
	...
	print #f3, "#if defined (PHANTOMAS_ENGINE) || defined (HANNA_ENGINE)"
	print #f3, "                    sc_terminado = (!(p_x >= sc_x - 15 && p_x <= sc_x + 15 && p_y >= sc_y - 15 && p_y <= sc_y + 15));"
	print #f3, "#elif defined (PLAYER_NEW_GENITAL)"
	print #f3, "                    //sc_terminado = (0 == (gpx + 8 >= sc_x && gpx + 8 <= sc_x + 15 && gpy + 14 >= sc_y - 15 && gpy + 14 <= sc_y + 15));"
	print #f3, "                    sc_terminado = (0 == (gpx + 8 >= sc_x && gpx <= sc_x + 7 && gpy + 29 >= sc_y && gpy <= sc_y + 1));"
	print #f3, "#else"
...
if clausulasUsed (&H21) Then
	...
	print #f3, "#if defined (PHANTOMAS_ENGINE) || defined (HANNA_ENGINE)"
	print #f3, "                    sc_terminado = (!(p_x >= sc_x && p_x <= sc_y));"
	print #f3, "#else"
...
if clausulasUsed (&H22) Then
	...
	print #f3, "                    sc_y = read_byte ();"
	print #f3, "#if defined (PHANTOMAS_ENGINE) || defined (HANNA_ENGINE)"
	print #f3, "                    sc_terminado = (!(p_y >= sc_x && p_y <= sc_y));"
	print #f3, "#else"	
...
if actionsUsed (&HE0) Then
	...
	print #f3, "#ifdef MODE_128K"
	print #f3, "                        _AY_PL_SND (read_vbyte ());"
	print #f3, "#else"
...
If actionsUsed (&HEA) Then
	...
	print #f3, "#if defined (PHANTOMAS_ENGINE) || defined (HANNA_ENGINE)"
	print #f3, "                        p_safe_x = p_x >> 4;"
	print #f3, "                        p_safe_y = p_y >> 4;"
	print #f3, "#else"
