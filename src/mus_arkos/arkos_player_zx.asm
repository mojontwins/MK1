...
;*** Optionnal sound effect API ************************************************
		...
		;	 D = Speed
		;	BC = Pitch offset
		; If the speed parameter is 0, the original instrument speed is used. Any value between
...
;					dw 4095,4095,4095,4095,4095,4095,4095,4095,4095,4030,3804,3591
					dw 3804,3591			; McKlain 10 notes fix
					...
					dw 2,2,1,1,1,1,1,1,1,1	; McKlain 10 notes fix
				else
